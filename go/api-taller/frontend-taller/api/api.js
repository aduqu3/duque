...
export default {
  ...
  async get_student_lowest_score(id) {
    try {
      return axios.get(api + 'student/low/' + id).then((res) => {
        return res.data.data
      })
    } catch (e) {
      if (e.response) {
  ...
  async get_more_old_gender_student(gender) {
    try {
      return axios.get(api + 'student/old/' + gender).then((res) => {
        return res.data.data
      })
    } catch (e) {
      if (e.response) {
